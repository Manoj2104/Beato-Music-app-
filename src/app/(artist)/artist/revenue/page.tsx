...
const COLORS = {
  bg: 'var(--color-ss-bg, #ffffff)',
  card: 'var(--color-ss-elevated, #ffffff)',
  card2: 'var(--color-ss-surface, #f8faf8)',
  cardHover: 'var(--color-ss-hover, #e8ece9)',
  border: 'var(--color-ss-border, rgba(15, 81, 50, 0.08))',
  borderActive: 'rgba(15, 81, 50, 0.3)',
  green: '#0f5132',
  text: 'var(--color-ss-text-primary, #0f172a)',
  muted: 'var(--color-ss-text-muted, #64748b)',
  yellow: '#eab308',
  blue: '#10b981',
  red: '#ef4444',
  orange: '#f97316',
    ...
    <div style={{ minHeight: '100vh', background: COLORS.bg, padding: '32px 24px', fontFamily: fontInter, color: COLORS.text }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16, marginBottom: 28 }}>
          ...
          <div style={{ 
            background: 'linear-gradient(135deg, rgba(15, 81, 50,0.08) 0%, rgba(18,18,18,0.7) 100%)', 
            ...
            boxShadow: isEligibleToWithdraw ? '0 8px 30px rgba(15, 81, 50, 0.08)' : 'none'
          }}>
            <div>
            ...
            <button 
              ...
              style={{ 
                ...
                boxShadow: isEligibleToWithdraw ? '0 4px 20px rgba(15, 81, 50, 0.3)' : 'none',
                transition: '0.2s'
              }}
                    ...
                    <div key={disp.id} style={{ background: COLORS.card2, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 12 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                        ...
                        <span style={{ 
                          ...
                          background: disp.status === 'resolved' ? 'rgba(15, 81, 50, 0.1)' : 'rgba(234, 179, 8, 0.1)',
