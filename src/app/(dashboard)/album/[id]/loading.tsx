  ...
  return (
    <div style={{ minHeight: '100%', background: '#fbf9f5' }}>
      ...
      <div style={{ display: 'flex', gap: 24, padding: '32px 24px 24px', alignItems: 'flex-end', background: 'linear-gradient(to bottom,#e2dbd0,#f4eede)' }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ height: 14, width: 60, borderRadius: 6, background: '#d4cdc2', marginBottom: 12, ...P }} />
          <div style={{ height: 40, width: 280, borderRadius: 10, background: '#d4cdc2', marginBottom: 10, ...P }} />
          <div style={{ height: 14, width: 180, borderRadius: 6, background: '#ded8cc', ...P }} />
        </div>
      </div>
      {/* Track list */}
      <div style={{ padding: '20px 24px' }}>
        {[...Array(10)].map((_,i) => (
          <div key={i} style={{ display: 'flex', gap: 14, alignItems: 'center', marginBottom: 14 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ height: 14, borderRadius: 5, background: '#e2dbd0', marginBottom: 6, width: '50%', ...P }} />
              <div style={{ height: 11, borderRadius: 5, background: '#ede7dc', width: '30%', ...P }} />
            </div>
